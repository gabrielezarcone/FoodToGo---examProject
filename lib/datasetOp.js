...
function updateServer(){
	var new_file = {};
	new_file['clienti'] = localStorage.getItem("clienti");
	new_file['ristoratori'] = localStorage.getItem("ristoratori");
	new_file['piatti'] = localStorage.getItem("piatti");
	new_file['ristoranti'] = localStorage.getItem("ristoranti");
	new_file['vende'] = localStorage.getItem("vende");
	new_file['acquista'] = localStorage.getItem("acquista");
	var xhr = new XMLHttpRequest();
	...
	xhr.send(JSON.stringify(new_file));
}
//-------------------------------------------------------------------------------------------
