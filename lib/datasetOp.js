...
function upload_initial_state(){
		...
		xhr.onload = ()=>{
				...
				localStorage.getItem("clienti")==null 		? updated=load("clienti", clienti): null;
				localStorage.getItem("ristoratori")==null 	? updated=load("ristoratori", ristoratori) : null;
				localStorage.getItem("piatti")==null 		? updated=load("piatti", piatti) : null;
				localStorage.getItem("ristoranti")==null 	? updated=load("ristoranti", ristoranti) : null;
				localStorage.getItem("vende")==null 		? updated=load("vende",vende) : null;
				localStorage.getItem("acquista")==null 		? updated=load("acquista", acquista) : null;
				//-----------------------------
				if(updated){
					location.reload();
				}
