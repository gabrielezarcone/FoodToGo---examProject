...
function upload_initial_state(){
		...
		xhr.onload = ()=>{
				...
				localStorage.getItem("clienti")==null ? localStorage.setItem("clienti", JSON.parse(clienti)): null;
				localStorage.getItem("ristoratori")==null ? localStorage.setItem("ristoratori", JSON.parse(ristoratori)) : null;
				localStorage.getItem("piatti")==null ? localStorage.setItem("piatti", JSON.parse(piatti)) : null;
				localStorage.getItem("ristoranti")==null ? localStorage.setItem("ristoranti", JSON.parse(ristoranti)) : null;
				localStorage.getItem("vende")==null ? localStorage.setItem("vende",JSON.parse(vende)) : null;
				localStorage.getItem("acquista")==null ? localStorage.setItem("acquista", JSON.parse(acquista)) : null;
		}
...
function updateServer(){
	...
	xhr.open('POST', 'service/upload_data.php');
